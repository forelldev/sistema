...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['btn'])) {
    ...
    try {
        ...
        $stmt1 = $conexion->prepare("INSERT INTO system_help (titulo, estado, fecha_solicitud, visto, remitente, observaciones_ayuda) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt1->bind_param("ssssss", $titulo, $estado, $fecha, $visto, $remitente, $observaciones_ayuda);
        $stmt1->execute();
