...
if (isset($_POST['btn'])) {
    ...
    if ($stmt) {
        ...
        $consulta_reporte = $consulta = $conexion->query("INSERT INTO reportes_solicitudes (rol,nombre,accion,fecha,id_doc) VALUES ('$rol','$nombre','Invalidó el documento','$fecha','$id_doc')");
