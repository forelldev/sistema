...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (isset($_GET['id'])) {      
      $sql = $conexion->prepare("SELECT * FROM system_help where id=:id");
      ...
      $sql = $conexion->prepare("SELECT * FROM system_help");
      $sql->execute();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    $input = $_POST;		
    $sql = "INSERT INTO system_help (titulo, estado, fecha) VALUES (:titulo, :estado, :fecha)";		  
